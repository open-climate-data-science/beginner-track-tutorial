...
Let's say we wanted to plot Max tempurature as a scatter plot over time? How would you modify the code from the above block?
...
- We can also use categorical variables on the x-axis, not just for coloring! 
